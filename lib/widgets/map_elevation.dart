                ...
                child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        ...
                        style: TextStyle(
                            fontSize: 25, fontWeight: FontWeight.bold,color: Colors.blueGrey[100]),
                      )
                    ]),
              )
          ]));
  ...
  _ElevationPainter(this.points,
    ...
    _min = (points
      ...
      return point.altitude;
        ...
        20)
        .floor() *
        20;                                     ///resizing the graph look (30,100)
    _max = (points
        .map((point) {
      if (point.altitude == null) return 0.0;
      return point.altitude;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (elevationGradientColors is ElevationGradientColors) {
      ...
      for (int i = 1; i < points.length; i++) {
        ...
        double gradient = 100 * dZ / dX;      /// RANGE OF values
        if (points[i].altitude > 14) {
          gradientColors.add(elevationGradientColors.gt30);
        } else if (points[i].altitude > 12) {
          gradientColors.add(elevationGradientColors.gt20);
        } else if (points[i].altitude > 8) {
