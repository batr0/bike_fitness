...
Stream<int> increment() async* {
  ...
  yield* Stream.periodic(Duration(seconds: 1), (int a) {
       return _CharacteristicTileState().widget.characteristic.lastValue[0].toInt();
  });
}

Stream get inc  =>increment().asBroadcastStream();  //getter is making this work now sending to graphs.dart
// ABOVE WORKING
...
//Stream inc = CharacteristicTile().characteristic.value.asBroadcastStream();




StreamSubscription ss = inc.listen(( data) {  // subscription testing
  //controller.addStream(inc);
  // controller.sink.addStream(inc);
});
                 ...
                 //   debugPrint(widget.characteristic.lastValue.toString());
                               ...
                               //debugPrint(myList.toString());
                                debugPrint(this.widget.characteristic.uuid.toString().toUpperCase().substring(4, 8).toString());
                                 debugPrint(this.widget.characteristic.lastValue.toString());// 483E value
                  }
              )
            ],
          ),
